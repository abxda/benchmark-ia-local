...
documentando sus **alcances** (calidad comparable a servicios comerciales en tareas
acotadas, operación sin conexión y con datos que no salen del equipo, modo agéntico con
auto-corrección) y sus **limitaciones** (velocidad de generación, memoria, debilidad de
los modelos en R y tiempos del modo desatendido), a fin de aportar elementos objetivos
para decidir sobre su adopción institucional.

---

*Material de soporte: `RESULTADOS.md` (benchmark completo, fases 1-5), reporte visual
HTML y harness reproducible (`bench.py`, `bench_cline.py`, `bench_zero.py`).*
