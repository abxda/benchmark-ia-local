...
# Resultados y workdirs se separan por perfil en carpetas distintas. No basta con
# grabar el perfil dentro del JSON: dos maquinas que etiquetan igual un mismo modelo
# colisionan en el nombre de archivo, y en Windows (case-insensitive) basta con que
# difieran en mayusculas para que una sobrescriba a la otra al hacer git pull.
RESULTS = BASE / "results" / PROFILE
WORK = BASE / "work" / PROFILE
